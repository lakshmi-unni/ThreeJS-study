...
const Homepage = () => {
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center bg-gray-100 p-4 space-y-6">
      <h1 className="text-3xl font-bold text-center">Welcome to Three.js Examples that I have tried.<br/> <span className='text-xl text-gray-500'>Click the buttons  to see the examples(drag/scroll or move mouse)</span></h1>
